export default [
	...
	},
	{
		...
		bullets: [
			'Improved memory efficiency by 82.5% on crucial binary data transfers from remote embedded system to mobile configuration application by creating custom iOS and Android native module for serialization.',
	...
	},
	{
		...
		location: "Bozeman, MT",
		dates: "2018 - 2019",
		description: "UI/UX development for Mobile + Desktop applications connecting to emedded Linux and RTOS sensors.",
		bullets: [
	...
	},
	{
		...
		bullets: [
			...
			'Enabled rapid I/O of filters by creating embedded Linux I/O control application server with DMA & Linux kernel driver passthrough to FPGA fabric.',
